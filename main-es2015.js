...
class CompanyFullPageComponent {
    ...
    loadReviews() {
        ...
        this.reviewService.getReviewsForCompany(this.currentCompanyName).subscribe(res => {
            ...
            this.auth.showHTTPLoader(false);
            res.forEach(element => {
                const el = element.payload.doc.data();
                this.reviews.push({
...
CompanyFullPageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CompanyFullPageComponent, selectors: [["app-company-full-page"]], decls: 37, vars: 26, consts: [[1, "gradient-background", "mt-75"], [1, "main-container", "container", "mt-5"], [1, "main-body", "container"], [1, "company-header"], [1, "company-info", "my-5", "d-flex", "justify-content-between"], [1, "fa", "fa-briefcase", "mr-2"], [1, "fa", "fa-map-marker", "mr-2"], [1, "company-body"], ["mat-raised-button", "", 1, "d-block", "mx-auto", "w-50", "mt-5", 3, "disabled", "click"], [1, "main-aside", "container"], [1, "img-container"], [1, "img-fluid", 3, "src", "alt"], [1, "fa", "fa-star", "mr-2"], [1, "fa", "fa-users", "mr-2"], ["href", "#", 1, "btn", "btn-danger", "d-block", "mx-auto"], [1, "fa", "fa-link", "mr-2"], ["class", "reviews-container container", 4, "ngIf"], [1, "reviews-container", "container"], ["class", "review-element", 4, "ngFor", "ngForOf"], [1, "review-element"], [1, "text-center"], ["mat-raised-button", "", "color", "warn", 1, "d-block", "mx-auto", "w-sm-100", "w-lg-25", 3, "routerLink"]], template: function CompanyFullPageComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_angular_material_button__WEBPACK_IMPORTED_MODULE_6__["MatButton"], _angular_common__WEBPACK_IMPORTED_MODULE_7__["NgIf"], _angular_common__WEBPACK_IMPORTED_MODULE_7__["NgForOf"], _angular_material_button__WEBPACK_IMPORTED_MODULE_6__["MatAnchor"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterLinkWithHref"]], pipes: [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_8__["TranslatePipe"]], styles: [".flex-column-center[_ngcontent-%COMP%], .main-aside[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n.animatedBefore[_ngcontent-%COMP%] {\n  position: relative;\n  color: var(--font-color);\n  padding: 5px;\n}\n.animatedBefore[_ngcontent-%COMP%]::before {\n  content: \"\";\n  position: absolute;\n  width: 0;\n  height: 2px;\n  bottom: 0;\n  left: 0;\n  background-color: var(--font-color);\n  transition: 0.4s;\n}\n.animatedBefore[_ngcontent-%COMP%]:hover::before {\n  content: \"\";\n  width: 100%;\n  transition: 0.4s;\n}\n.mt-6[_ngcontent-%COMP%] {\n  margin-top: 6rem;\n}\n.mt-75[_ngcontent-%COMP%] {\n  padding-top: 75px;\n}\n.underlineBefore[_ngcontent-%COMP%] {\n  position: relative;\n}\n.underlineBefore[_ngcontent-%COMP%]::before {\n  content: \"\";\n  position: absolute;\n  left: 0;\n  bottom: 0;\n  width: 100%;\n  height: 2px;\n  background-color: var(--font-color);\n}\n.fixed-full-height[_ngcontent-%COMP%] {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  height: 100%;\n}\n.td-none[_ngcontent-%COMP%] {\n  text-decoration: none;\n}\n.gradient-background[_ngcontent-%COMP%] {\n  background: linear-gradient(180deg, var(--secondary), var(--primary));\n}\n\n\n\nsection[_ngcontent-%COMP%] {\n  min-height: 100vh;\n  padding-bottom: 15px;\n}\nsection[_ngcontent-%COMP%]   p[_ngcontent-%COMP%], section[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%] {\n  color: var(--font-color);\n}\nsection[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  margin: 0;\n}\nsection[_ngcontent-%COMP%]   p[_ngcontent-%COMP%], section[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  font-size: 20px;\n}\n@media only screen and (min-width: 325px) and (max-width: 992px) {\n  section[_ngcontent-%COMP%]   p[_ngcontent-%COMP%], section[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n    font-size: 16px;\n  }\n}\nsection[_ngcontent-%COMP%]   i.fa[_ngcontent-%COMP%] {\n  font-size: 26px;\n}\n@media only screen and (min-width: 325px) and (max-width: 992px) {\n  section[_ngcontent-%COMP%]   i.fa[_ngcontent-%COMP%] {\n    font-size: 20px;\n  }\n}\nsection[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%] {\n  position: relative;\n  font-size: 52px;\n  padding-bottom: 10px;\n}\n@media only screen and (min-width: 325px) and (max-width: 992px) {\n  section[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%] {\n    font-size: 32px;\n  }\n}\n.main-container[_ngcontent-%COMP%] {\n  display: flex;\n}\n@media only screen and (min-width: 325px) and (max-width: 992px) {\n  .main-container[_ngcontent-%COMP%] {\n    display: block;\n  }\n}\n.img-fluid[_ngcontent-%COMP%] {\n  width: 150px;\n}\n.company-info[_ngcontent-%COMP%] {\n  position: relative;\n  padding-bottom: 25px;\n}\n.main-aside[_ngcontent-%COMP%] {\n  border: 1px solid var(--font-color);\n  margin-left: 5rem;\n  border-radius: 15px;\n  box-shadow: inset 0 0 3px 0 var(--font-color);\n}\n.main-aside[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  margin: 1rem 0;\n}\n@media only screen and (min-width: 325px) and (max-width: 992px) {\n  .main-aside[_ngcontent-%COMP%] {\n    margin: 3rem 0 1rem 0;\n  }\n}\n@media only screen and (min-width: 325px) and (max-width: 992px) {\n  .main-aside[_ngcontent-%COMP%]   a.btn[_ngcontent-%COMP%] {\n    margin-bottom: 1rem;\n  }\n}\n.reviews-container[_ngcontent-%COMP%] {\n  margin-top: 5rem;\n  padding-top: 2rem;\n  border-top: 3px solid var(--font-color);\n}\n.reviews-container[_ngcontent-%COMP%]   .review-element[_ngcontent-%COMP%] {\n  background: linear-gradient(163deg, var(--tertiary) 0%, var(--primary) 100%);\n  padding: 1rem;\n  box-shadow: 0 0 5px 0 var(--shadows);\n  border-radius: 5px;\n  margin-bottom: 2rem;\n  width: 50%;\n  overflow: hidden;\n}\n@media only screen and (min-width: 325px) and (max-width: 992px) {\n  .reviews-container[_ngcontent-%COMP%]   .review-element[_ngcontent-%COMP%] {\n    width: 100%;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
